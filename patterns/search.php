...
/**
 * Title: search
 * Slug: ask-design-blog-child/search
 * Inserter: no
 */
?>
...
<main class="wp-block-group" style="margin-top:3.75rem"><!-- wp:query-title {"type":"search"} /-->

<!-- wp:search {"label":"Search","showLabel":false,"placeholder":"Type here...","buttonText":"Search","metadata":{"patternName":"twentytwentyfive/hidden-search","name":"Search"},"style":{"border":{"width":"1px","radius":{"topLeft":"0.38rem","topRight":"0.38rem","bottomLeft":"0.38rem","bottomRight":"0.38rem"}}},"borderColor":"custom-accent-200"} /-->

<!-- wp:query {"queryId":73,"query":{"perPage":9,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true,"taxQuery":null,"parents":[],"excludeCurrent":null},"metadata":{"categories":["Posts"],"patternName":"ask-design-blog-child/search-results-3-col-new","name":"Search Results (3-col new)"},"align":"wide","layout":{"type":"default"}} -->
...
<!-- wp:post-date {"datetime":"2026-08-25T21:11:49.100Z"} /-->
