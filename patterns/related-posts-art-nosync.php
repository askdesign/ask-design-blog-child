<?php
/**
 * Title: Related posts - Art (nosync)
 * Slug: ask-design-blog-child/related-posts-art-nosync
 * Categories: Posts
 */
?>
...
<!-- wp:query {"queryId":37,"query":{"perPage":4,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"include":{"category":[3]}},"parents":[]},"align":"wide","layout":{"type":"default"}} -->
