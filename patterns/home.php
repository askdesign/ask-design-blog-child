...
/**
 * Title: home
 * Slug: ask-design-blog-child/home
 * Inserter: no
 */
?>
<!-- wp:template-part {"slug":"header"} /-->

<!-- wp:group {"tagName":"main","style":{"spacing":{"margin":{"top":"3.75rem"}}},"layout":{"type":"constrained"}} -->
<main class="wp-block-group" style="margin-top:3.75rem"><!-- wp:heading {"level":1,"align":"wide","style":{"typography":{"textAlign":"center"}},"fontSize":"xx-large"} -->
<h1 class="wp-block-heading has-text-align-center alignwide has-xx-large-font-size">More Articles</h1>
<!-- /wp:heading -->

<!-- wp:query {"queryId":72,"query":{"perPage":9,"pages":0,"offset":"13","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":null,"parents":[],"excludeCurrent":null},"metadata":{"patternName":"twentytwentyfive/template-query-loop-photo-blog","name":"Photo blog posts","description":"A list of posts, 3 columns, with only featured images.","categories":["query"]},"align":"wide","layout":{"type":"default"}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"2.5rem","bottom":"2.5rem"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group" style="padding-top:2.5rem;padding-bottom:2.5rem"><!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"grid","columnCount":null,"minimumColumnWidth":"23rem"}} -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://www.askdesign.biz/blog" target="_blank" rel="noreferrer noopener">BLOG HOME</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:query --></main>
