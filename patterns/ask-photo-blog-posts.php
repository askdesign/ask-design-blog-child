<?php
/**
 * Title: ASK photo blog posts 2
 * Slug: ask-design-blog-child/ask-photo-blog-posts-2
 * Categories: Posts
 */
?>
<!-- wp:query {"queryId":72,"query":{"perPage":9,"pages":0,"offset":"13","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":null,"parents":[]},"metadata":{"patternName":"twentytwentyfive/template-query-loop-photo-blog","name":"Photo blog posts","description":"A list of posts, 3 columns, with only featured images.","categories":["query"]},"align":"wide","layout":{"type":"default"}} -->
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"grid","columnCount":null,"minimumColumnWidth":"23rem"}} -->
