<?php
/**
 * Title: Related posts - Graphic design (nosync)
 * Slug: ask-design-blog-child/related-posts-graphic-design-nosync
 * Categories: Posts
 */
?>
...
<h2 class="wp-block-heading alignwide has-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:1.4px;text-transform:uppercase">Related posts</h2>
<!-- /wp:heading -->

<!-- wp:query {"queryId":37,"query":{"perPage":4,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"include":{"category":[6]}},"parents":[]},"align":"wide","layout":{"type":"default"}} -->
